...
const STATE_ROSTER_CACHE_VERSION = 'v2';
// --- Marker holding the Worker version that last seeded (drives the seed-on-new-version refresh). ---
export const SEEDED_VERSION_KEY = 'meta:seeded-version';
// --- A roster newer than this is skipped on re-seed; the weekly cron refreshes it after this window. ---
export const SEED_FRESHNESS_WINDOW_MS = 6 * 24 * 60 * 60 * 1000; // --- six days ---
...
export const stateCacheKey = (code: string): string =>
	`state:${STATE_ROSTER_CACHE_VERSION}:${code.toUpperCase()}`;
// ∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞
...
export const CENSUS_LOCATION_FIELDS: Array<CensusLocationField> = [
	{
		locationKey: 'state',
		geographyNameIncludes: ['states'],
		valueKeys: ['STUSAB', 'NAME'],
	},
	{
		locationKey: 'congressionalDistrict',
		geographyNameIncludes: ['congressional districts'],
		valueKeys: ['BASENAME', 'CD119', 'CD118', 'GEOID'],
	},
	{
		locationKey: 'stateHouseDistrict',
		geographyNameIncludes: ['state legislative districts - lower'],
		valueKeys: ['BASENAME', 'SLDLST', 'GEOID'],
	},
	{
		locationKey: 'stateSenateDistrict',
		geographyNameIncludes: ['state legislative districts - upper'],
		valueKeys: ['BASENAME', 'SLDUST', 'GEOID'],
	},
];
// ∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞
