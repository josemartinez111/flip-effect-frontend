...
// > REPRESENTATIVE_SHARED.TS
// ∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞

// --- App-facing contract (must match the frontend CivicRepresentative model) ---
...
// --- Raw upstream shapes (congress-legislators / census / open states) ---
...
// --- CORS allowlist: Vite dev + the production domain (frontend not yet on theflipeffect.us). ---
export const ALLOWED_ORIGINS = ['http://localhost:5173', 'https://theflipeffect.us'];
...
// --- Census geography fields we lift out of a geocoder match ---
